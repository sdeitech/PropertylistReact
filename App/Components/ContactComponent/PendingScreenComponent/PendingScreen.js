...
import { getPendingContactList } from "../../../Action/ActionCreators";
...
class PendingScreen extends PureComponent {
      ...
      .then(value => {
        if (value) {
          ...
          var postData = {
            ...
            status: Strings.CONTACT_REQUEST_PENDING
          };
          this.props.getPendingContactList(postData, userData.token);
        }
      })
      .done();
  }
  ...
  componentWillReceiveProps(nextProps) {
    ...
    var response = nextProps.ContactReducer.pendingContactList;
  ...
  renderList(item, index) {
    ...
    return (
      <CardView
        cardElevation={15}
        cornerRadius={5}
        style={PendingScreenStyle.updateForm}>
...
function mapDispatchToProps(dispatch) {
  return bindActionCreators({ getPendingContactList }, dispatch);
}
